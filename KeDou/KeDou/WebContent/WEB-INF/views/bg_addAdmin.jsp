...
<script type="text/javascript">
	function validate(){
		...
		var name=document.addAdmin.adminAccount.value;
			if(pwd==pwd2){
				if(pwd != ""){
	...
	function endsubmit(){
		...
		if(name!=""){
			...
			document.getElementById("alertAccount").innerHTML="<font color='red'>管理员账户不能为空</font>";
			account=account+1;
		}
		if(account!=0){
			return false;
...
<div id="content">
    ...
    <!-- 
        ...
        <tbody>
          <tr>
          <td>管理员账号</td>
          <td><input id="adminAccount" onkeyup="validate()" name="adminAccount" class="form-control form-focus" autofocus type="text" placeholder="输入账号">
        ...
        <tr>
          <td>确认密码</td>
          <td><input name="adminPwd2" onblur="validate()" class="form-control form-focus" autofocus type="password" placeholder="再次输入密码"><span id="tishi"></span></td>
        </tr>
        <tr>
        	<td>
        		<span id="tishi"></span>
